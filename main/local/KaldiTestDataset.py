...
from KaldiDatasetFunctions import check_files_exist, move_files_to_directory, check_and_install
import time
check_and_install('textgrid')
from textgrid import TextGrid

print("this is the KaldiTestDataset.py file")
start= time.time()
# make two variables to store the input and output directories
output_dir = "data/test"
output_relative_dir = "../main"
input_dir = "corpus/test_source"
...
# path setting here, this is the files in data/test
